...
void AutoMaintenanceOnLevelupAction::AutoUpgradeEquip()
{
    ...
    // Strict BiS mode re-applies the list on every levelup pass, independently of
    // AutoUpgradeEquip: the list is the target state, not an opportunistic upgrade.
    if (!PlayerbotFactory::ApplyStrictBisEquipment(bot) && sPlayerbotAIConfig.autoUpgradeEquip)
